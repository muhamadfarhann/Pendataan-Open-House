            ...
            <?php echo form_open('senior/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="divisi" class="form-control">
								...
								{
									$selected = ($value == $this->input->post('divisi')) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="angkatan" class="form-control">
								...
								{
									$selected = ($value == $this->input->post('angkatan')) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						<label for="no_wa" class="control-label"><span class="text-danger">*</span>No Whatsapp</label>
						<div class="form-group">
